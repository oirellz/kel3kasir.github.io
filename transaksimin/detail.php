...
$_SESSION['id']=$data['penjualan_id'];
        ...
        <br>
        <input type="submit" class="btn btn-info mb-1" name="save" value="Simpan">
        </form>
        <hr>
<table border="1">
...
<table class="table">
	...
	onclick="return confirm('Apakah Anda Yakin data transaksi <?= $detail['nama_produk'] ?> akan dihapus?')" class="btn btn-danger">Hapus</a>
</td>
    </tr>
